 ...
 *
 * **集める手と畳む手を分けてある。** 以前はこの関数が「読めない段があった」と
 * 「段ごとに major が食い違う」の**両方を `null` へ畳んで**いたため、
 ...
 * **直すべきは段のドリフトなのに読み取り側を疑わせる**案内になっていた。
 * これは describeMissingRuntimeMajor が防ごうとしている取り違え
 * (「読めない」を「揃っていない」と言わない) の**ちょうど裏返し**で、
 * そちら向きだけが手当てされていなかった。
 */
